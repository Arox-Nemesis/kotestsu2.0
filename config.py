...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003937401667")) #Your db channel Id
OWNER = os.environ.get("OWNER", "its_tussu") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "8480922250")) # Owner id
#--------------------------------------------
